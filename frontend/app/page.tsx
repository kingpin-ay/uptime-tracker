...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Keep track of your websites, APIs, and cron jobs with our
                    reliable monitoring system. Get instant alerts when
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Our platform provides comprehensive monitoring solutions for
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-4">
                ...
                <p className="text-center text-muted-foreground">
                  Monitor your websites and APIs with regular health checks at
              ...
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-4">
                ...
                <p className="text-center text-muted-foreground">
                  Verify your scheduled tasks are running on time with unique
                  ping URLs.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-4">
                ...
                <p className="text-center text-muted-foreground">
                  Receive immediate notifications when your services experience
                  downtime.
                </p>
              </div>
            </div>
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    Our simple setup process gets you up and running quickly. No
      ...
      <footer className="w-full border-t py-6 md:py-8 flex justify-center">
        <div className="container flex flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <p className="text-center text-sm text-muted-foreground md:text-left">
            &copy; {new Date().getFullYear()} UptimeMonitor. All rights
            reserved.
          </p>
